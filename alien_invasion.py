...
class AlienInvasion:
    ...
    def __init__(self):
        """Initialize core components and resources."""
        pygame.init()
        pygame.mixer.init()
    ...
    def _check_collisions(self):
        """Handle all collisions and related status checks."""
        ...
        collisions = self.alien_fleet.check_collisions(
            self.ship.bullet_manager.active_bullets
        )
        if collisions:
            self.impact.play()
    ...
    def reset_level(self):
        """Clear bullets and rebuild alien fleet."""
